...
The slots fall in three facets by what each source measures, said before any was set against a valuation: the esteem of critics and scholars (A, F, H), the reach of the book beyond literature (D, G, I), and the canon of what the public is told to read (B, C, E). The three agree with each other closely, 0.70 to 0.87: the nine sources measure one thing.
